...
public class PrepareSusyWeighted_2 {
  ...
  public static void main(String args[]) {
	...
	Double Maximo=0.0;
	 System.out.println("Start PrepareSusyWeighted_2.java");
    try {
   ...
   //     while( ((linea = br.readLine()) != null) && (Conta  < 4500000.0))
    ...
    case 2:
   	  ...
   	  default:
   		  System.out.println(" Rare,  type of priority that is not 0, 1 or 2 is sneaked, bad training file selected") ;
  ...
  //**************************************************************************************
     ...
     // Case of considering the last 500,000 records as test
        ...
        { 
         ...
         for(int z=1; z<9; z++)
         {
			...
			if ( (indice > ( TopeMemoria - 2) )|| (indice < 0))
			{
				System.out.println(" Index overflowed=" + indice + " en the field="+z );
				indice=TopeMemoria ;
			}
    ...
    System.out.println(" Records counted type 0 = " +  Cont0); 
     ...
     System.out.println(" Records counted type 2 = " + Cont2); 
