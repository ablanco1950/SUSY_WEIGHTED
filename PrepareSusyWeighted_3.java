...
public class PrepareSusyWeighted_3 {
  ...
  public static void main(String args[]) {
	...
	Double Maximo=0.0;
	 System.out.println("Start PrepareSusyWeighted_3.java");
   ...
   //     while( ((linea = br.readLine()) != null) && (Conta  < 4500000.0))
    ...
    case 2:
   	  ...
   	  default:
   		  System.out.println(" Rare,  type of priority that is not 0, 1, 2 or 3 is sneaked, bad training file selected");
  ...
  //**************************************************************************************
    ...
    System.out.println(" Records counted type 0 = " + Cont0); 
     ...
     System.out.println(" Records counted type 3 = " + Cont3);
